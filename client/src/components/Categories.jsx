...
const services = [
  { name: 'Document Printing', icon: '📄', desc: 'B/W and Color printing for PDFs, Word docs, spreadsheets & more.', price: 'From ₹2/page', link: '/print', color: 'blue' },
  { name: 'Photo Printing', icon: '🖼️', desc: 'High-quality photo prints in all sizes — matte and glossy finishes.', price: 'From ₹10/print', link: '/print', color: 'orange' },
  { name: 'ID Card Printing', icon: '🪪', desc: 'PVC ID Cards, Visitor Passes, Student IDs with lamination.', price: 'From ₹100/card', link: '/print', color: 'green' },
  { name: 'Spiral Binding', icon: '📚', desc: 'Professional spiral, staple, and hard binding for your documents.', price: 'From ₹50', link: '/print', color: 'purple' },
